...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(company-tooltip ((,class (:foreground ,base3 :background ,base1))))
   ...
   `(org-level-1 ((,class (:foreground ,base3 :height 1.0))))
   ...
   `(show-paren-match ((,class (:foreground ,base1 :background ,base5))))
