...
(custom-set-variables
 ...
 '(beacon-dont-blink-major-modes
   (quote
    (t magit-status-mode magit-popup-mode magit-refs-mode inf-ruby-mode gnus-summary-mode gnus-group-mode eshell-mode sbt-mode ensime-mode compilation-mode neotree-mode)))
 '(beacon-size 15)
